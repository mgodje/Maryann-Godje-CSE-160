function drawOwl(){
    ...
    head.matrix.rotate(-g_joint1, 0, 0, 1);
    ...
    right_ear.matrix.rotate(-g_joint2, 0, 0, 1);
    ...
    left_ear.matrix.rotate(-g_joint2, 0, 0, 1);
    ...
    left_wing.matrix.rotate(-g_joint3, 0, 0, 1);
    ...
    left_wing.color = [0.6, 0.59, 0.4, 1.0];
    left_wing.matrix.translate(0.07, 0, 0.0);
    left_wing.matrix.rotate(-g_joint4, 0, 0, 1);
